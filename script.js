...
const legendDefinitions = {
  ...
  rows: [
    ...
    ['#FEC980', 'средняя обеспеченность<br><span style="font-size:11px;color:#666;">(обеспечены только общественным транспортом)</span>'],
    ['#C7E8AD', 'высокая обеспеченность<br><span style="font-size:11px;color:#666;">(обеспечены и велопарковками, и общественным транспортом)</span>']
  ]
},
  public_transport_grid: {
    title: 'Сетка обеспеченности общественным транспортом',
    rows: [
      ['#F7FCF5', '1 класс — минимальная обеспеченность'],
      ['#C9EAC2', '2 класс — пониженная обеспеченность'],
      ['#7BC77C', '3 класс — средняя обеспеченность'],
      ['#2A924B', '4 класс — высокая обеспеченность']
    ]
  },
  bicycle_parking_grid: {
    title: 'Сетка обеспеченности велопарковками',
    rows: [
      ['#FFF5F0', '1 класс — минимальная обеспеченность'],
      ['#FCBEA5', '2 класс — пониженная обеспеченность'],
      ['#FB7050', '3 класс — средняя обеспеченность'],
      ['#D32020', '4 класс — высокая обеспеченность']
    ]
  },
...
const echpochmakFacts = [
  "Татарстан — республика в составе России, столица которой — Казань",
  "В Татарстане используются два государственных языка: русский и татарский",
  "Сабантуй — один из самых известных традиционных праздников Татарстана",
  "Татарстан известен богатой культурной, музыкальной и кулинарной традицией",
  "Казань — один из крупнейших культурных и образовательных центров Поволжья",
  "А меня зовут Эчпочмак, и я одно из самых известных национальных блюд Татарстана"
];
